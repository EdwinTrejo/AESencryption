...
namespace UnitTests.UART
{
    ...
    public class UARTTests
    {
        ...
        private const int send_delay_for_start = 50;

        //MAESTESTINGMAEST
        //4d41455354455354494e474d41455354
        private readonly byte[] TEST_INSTRUCTION = { 0x4d, 0x41, 0x45, 0x53, 0x54, 0x45, 0x53, 0x54, 0x49, 0x4e, 0x47, 0x4d, 0x41, 0x45, 0x53, 0x54 };
        ...
        private readonly byte[] TEST_PLAINTEXT = { 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff };

        // 2b7e151628aed2a6abf7158809cf4f3c
        private readonly byte[] TEST_KEY = { 0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c };

        // 8DF4E9AAC5C7573A27D8D055D6E4D64B
        private readonly byte[] TEST_CYPHERTEXT = { 0x8D, 0xF4, 0xE9, 0xAA, 0xC5, 0xC7, 0x57, 0x3A, 0x27, 0xD8, 0xD0, 0x55, 0xD6, 0xE4, 0xD6, 0x4B };

        // making sure that even null terminators can be sent
        private readonly byte[] TEST_RANDOM_TEXT = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
