...
HD_PWD='C:/Users/horse/Documents/Xilinx_Projects/mblaze_test/mblaze_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mblaze_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mblaze_test_wrapper.tcl -notrace
