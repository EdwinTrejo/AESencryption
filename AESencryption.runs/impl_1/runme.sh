...
HD_PWD='C:/Users/horse/Documents/Xilinx_Projects/AESencryption/AESencryption.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EncDecController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EncDecController.tcl -notrace
