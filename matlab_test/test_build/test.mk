...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\test_win64.dll
...
SRCS = $(START_DIR)\test_build\test.c $(START_DIR)\test_build\test_capi.c $(START_DIR)\test_build\test_dpi.c
...
OBJS = test.obj test_capi.obj test_dpi.obj
...
{$(START_DIR)\test_build}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_build}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
test.obj : $(START_DIR)\test_build\test.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\test_build\test.c


test_capi.obj : $(START_DIR)\test_build\test_capi.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\test_build\test_capi.c


test_dpi.obj : $(START_DIR)\test_build\test_dpi.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\test_build\test_dpi.c
