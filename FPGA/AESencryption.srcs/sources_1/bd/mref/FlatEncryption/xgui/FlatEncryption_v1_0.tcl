...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "state10" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state11" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state12" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state13" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state14" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state15" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state2" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state3" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state4" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state5" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state6" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state7" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state8" -parent ${Page_0}
  ipgui::add_param $IPINST -name "state9" -parent ${Page_0}
...
proc update_PARAM_VALUE.state10 { PARAM_VALUE.state10 } {
	# Procedure called to update state10 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state10 { PARAM_VALUE.state10 } {
	# Procedure called to validate state10
	return true
}

proc update_PARAM_VALUE.state11 { PARAM_VALUE.state11 } {
	# Procedure called to update state11 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state11 { PARAM_VALUE.state11 } {
	# Procedure called to validate state11
	return true
}

proc update_PARAM_VALUE.state12 { PARAM_VALUE.state12 } {
	# Procedure called to update state12 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state12 { PARAM_VALUE.state12 } {
	# Procedure called to validate state12
	return true
}

proc update_PARAM_VALUE.state13 { PARAM_VALUE.state13 } {
	# Procedure called to update state13 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state13 { PARAM_VALUE.state13 } {
	# Procedure called to validate state13
	return true
}

proc update_PARAM_VALUE.state14 { PARAM_VALUE.state14 } {
	# Procedure called to update state14 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state14 { PARAM_VALUE.state14 } {
	# Procedure called to validate state14
	return true
}

proc update_PARAM_VALUE.state15 { PARAM_VALUE.state15 } {
	# Procedure called to update state15 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state15 { PARAM_VALUE.state15 } {
	# Procedure called to validate state15
	return true
}
...
proc update_PARAM_VALUE.state4 { PARAM_VALUE.state4 } {
	# Procedure called to update state4 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state4 { PARAM_VALUE.state4 } {
	# Procedure called to validate state4
	return true
}

proc update_PARAM_VALUE.state5 { PARAM_VALUE.state5 } {
	# Procedure called to update state5 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state5 { PARAM_VALUE.state5 } {
	# Procedure called to validate state5
	return true
}

proc update_PARAM_VALUE.state6 { PARAM_VALUE.state6 } {
	# Procedure called to update state6 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state6 { PARAM_VALUE.state6 } {
	# Procedure called to validate state6
	return true
}

proc update_PARAM_VALUE.state7 { PARAM_VALUE.state7 } {
	# Procedure called to update state7 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state7 { PARAM_VALUE.state7 } {
	# Procedure called to validate state7
	return true
}

proc update_PARAM_VALUE.state8 { PARAM_VALUE.state8 } {
	# Procedure called to update state8 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state8 { PARAM_VALUE.state8 } {
	# Procedure called to validate state8
	return true
}

proc update_PARAM_VALUE.state9 { PARAM_VALUE.state9 } {
	# Procedure called to update state9 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.state9 { PARAM_VALUE.state9 } {
	# Procedure called to validate state9
	return true
}
...
proc update_MODELPARAM_VALUE.state4 { MODELPARAM_VALUE.state4 PARAM_VALUE.state4 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state4}] ${MODELPARAM_VALUE.state4}
}

proc update_MODELPARAM_VALUE.state5 { MODELPARAM_VALUE.state5 PARAM_VALUE.state5 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state5}] ${MODELPARAM_VALUE.state5}
}

proc update_MODELPARAM_VALUE.state6 { MODELPARAM_VALUE.state6 PARAM_VALUE.state6 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state6}] ${MODELPARAM_VALUE.state6}
}

proc update_MODELPARAM_VALUE.state7 { MODELPARAM_VALUE.state7 PARAM_VALUE.state7 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state7}] ${MODELPARAM_VALUE.state7}
}

proc update_MODELPARAM_VALUE.state8 { MODELPARAM_VALUE.state8 PARAM_VALUE.state8 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state8}] ${MODELPARAM_VALUE.state8}
}

proc update_MODELPARAM_VALUE.state9 { MODELPARAM_VALUE.state9 PARAM_VALUE.state9 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state9}] ${MODELPARAM_VALUE.state9}
}

proc update_MODELPARAM_VALUE.state10 { MODELPARAM_VALUE.state10 PARAM_VALUE.state10 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state10}] ${MODELPARAM_VALUE.state10}
}

proc update_MODELPARAM_VALUE.state11 { MODELPARAM_VALUE.state11 PARAM_VALUE.state11 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state11}] ${MODELPARAM_VALUE.state11}
}

proc update_MODELPARAM_VALUE.state12 { MODELPARAM_VALUE.state12 PARAM_VALUE.state12 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state12}] ${MODELPARAM_VALUE.state12}
}

proc update_MODELPARAM_VALUE.state13 { MODELPARAM_VALUE.state13 PARAM_VALUE.state13 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state13}] ${MODELPARAM_VALUE.state13}
}

proc update_MODELPARAM_VALUE.state14 { MODELPARAM_VALUE.state14 PARAM_VALUE.state14 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state14}] ${MODELPARAM_VALUE.state14}
}

proc update_MODELPARAM_VALUE.state15 { MODELPARAM_VALUE.state15 PARAM_VALUE.state15 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.state15}] ${MODELPARAM_VALUE.state15}
}
