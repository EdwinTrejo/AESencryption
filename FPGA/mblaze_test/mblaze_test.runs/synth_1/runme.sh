...
HD_PWD='C:/Users/horse/Documents/Xilinx_Projects/mblaze_test/mblaze_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mblaze_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mblaze_test_wrapper.tcl
