...
HD_PWD='C:/Users/horse/Documents/Xilinx_Projects/mblaze_test/mblaze_test.runs/mblaze_test_microblaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mblaze_test_microblaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mblaze_test_microblaze_0_1.tcl
